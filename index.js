...
// founder
const founder = "7teen#3868"; // if you change this you're a skid ;)
...
console.log(``);
console.log(green(`                                          Made by 7teen#3868`));
console.log(``);                                            
console.log(``);
console.log(yellow('               + ================================================================================== +'));
...
bot.on('message', message => {
    ...
    if (message.content.startsWith(prefix + 'general')) {
        const helpembed = new RichEmbed()
            .setTitle(`extendo selfbot: general`)
    ...
    if (message.content.startsWith(prefix + 'server')) {
        const helpembed = new RichEmbed()
            .setTitle(`extendo selfbot: server`)
    ...
    if (message.content.startsWith(prefix + 'status')) {
        const helpembed = new RichEmbed()
            .setTitle(`extendo selfbot: status`)
    ...
    if (message.content.startsWith(prefix + 'mass')) {
        const helpembed = new RichEmbed()
            .setTitle(`extendo selfbot: mass`)
            .setDescription(`\`dm\` - **Mass DMs Server (wont reach all)** \n \`fdm\` - **Mass DMs Friends List**`)
            .setColor("#000000")
            .setImage("")
            .setFooter(`prefix: ${prefix}`);
        message.channel.send(helpembed);
    ...
    if (message.content.startsWith(prefix + 'others')) {
        const helpembed = new RichEmbed()
            .setTitle(`extendo selfbot: others`)
            .setDescription(`\`spam\` **[ID] [CONTENT]**`)
            .setColor("#000000")
            .setImage("")
            .setFooter(`prefix: ${prefix} | More coming soon...`);
        message.channel.send(helpembed);
                message.delete();
    }
    ...
    if (message.content.startsWith(prefix + 'sinvback')) {
        ...
        invitebackground.setFooter(`Invite Background | 7teen#3868`)
